...
export function WorkspaceStatusline(): React.JSX.Element {
  ...
  return (
    <div
      ...
      className="flex items-center gap-3 px-2.5 border-t border-border bg-surface h-(--statusline-h) shrink-0 font-mono text-[length:var(--text-statusline)] text-muted whitespace-nowrap overflow-hidden"
    >
      {projectName && (
